  ...
  - class: ResourceRequirement
    ramMin: |-
      ${
        ...
        var base = Math.min(Math.max(48000, Math.round(bam_mb * 6) + 8000), 240000);
        if (inputs.memory_per_job && inputs.memory_overhead)
    ...
    outdirMin: |-
      ${
        var bam_mb = inputs.input.size / (1024 * 1024);
        return Math.min(Math.max(15360, Math.round(bam_mb * 2) + 8000), 240000);
      }
    tmpdirMin: |-
      ${
        var bam_mb = inputs.input.size / (1024 * 1024);
        return Math.min(Math.max(15360, Math.round(bam_mb * 1) + 8000), 240000);
      }
