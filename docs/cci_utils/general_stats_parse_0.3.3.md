...
|--- |--- |--- |
| cci_utils   | 0.3.3  |  <https://github.com/msk-access/cci_utils> |
...
usage: general_stats_parse.cwl [-h] --directory DIRECTORY --samples-json
                               SAMPLES_JSON [--config CONFIG] --hotspot-file HOTSPOT_FILE
                               [job_order]
...
optional arguments:
  ...
  --hotspot-file HOTSPOT_FILE       Location of hotspotfile.
```
